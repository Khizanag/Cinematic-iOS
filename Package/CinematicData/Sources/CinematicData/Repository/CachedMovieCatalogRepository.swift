...
/// in-memory catalog.
public struct CachedMovieCatalogRepository: MovieCatalogRepository {
    private let wrapped: any MovieCatalogRepository
    private let cache: DiskCache

    public init(wrapping wrapped: any MovieCatalogRepository) {
        self.init(wrapping: wrapped, cache: DiskCache(name: "MovieCatalog"))
    }

    init(wrapping wrapped: any MovieCatalogRepository, cache: DiskCache) {
